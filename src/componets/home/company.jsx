...
export default function TopRecruitersSwap() {
  ...
  return (
    <section className="bg-[#f5f9ff] text-center py-10 overflow-hidden font-poppins">
      ...
      <div className="relative w-full bg-white shadow-[0_-2px_0_rgba(0,0,0,0.1),0_2px_0_rgba(0,0,0,0.1)] py-8 px-4 min-h-[200px] flex items-center justify-center">
        <AnimatePresence mode="wait" initial={false}>
          <motion.div
            key={currentSet}
            className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 items-center justify-center max-w-6xl mx-auto w-full"
            ...
            {currentLogos.map((logo, index) => (
              ...
              >
                <Image
                  ...
                  width={180}
                  height={100}
                  className="object-contain w-full h-[80px] sm:h-[100px] md:h-[120px] hover:scale-105 transition-transform duration-300"
