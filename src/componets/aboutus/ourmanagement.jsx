...
export default function OurManagement() {
  return (
    <>
    <div className="bg-[#f4f8ff] font-poppins">  <h2 className="text-2xl md:text-5xl text-center md:text-center py-10 font-extrabold text-[#1F2A44] ">Our Management</h2></div>
